...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fe', builtin.diagnostics, { desc = '[S]earch [E]rrors / diagnostics' })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {}
      -- check if npm exists to detect development environments
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      parsers.motoko = {
        install_info = {
          url = 'https://github.com/christoph-dfinity/tree-sitter-motoko',
          files = { 'src/parser.c' },
          branch = 'main',
        },
      }
      ...
      local filetypes = {
        ...
        'css', 'scss', 'javascript', 'typescript', 'motoko',
      }
